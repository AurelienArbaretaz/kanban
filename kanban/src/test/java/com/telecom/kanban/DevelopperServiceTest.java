...
@DataJpaTest
public class DevelopperServiceTest {
	@Autowired
	private  DevelopperRepository developperRepository;
	
	@Test
	public void findAllDevTest() {
		DevelopperServiceImpl developperServiceImpl = new DevelopperServiceImpl();
		Task t1 =new Task();
		...
		List<Developper> devs = developperServiceImpl.findAll(developperRepository);
